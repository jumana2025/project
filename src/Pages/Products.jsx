...
function Products() {
    ...
    useEffect(() => {
        ...
        Promise.all([
            ...
            .then(([ringsRes, braceletsRes, necklacesRes]) => {
                // Merge arrays into one
                const allProducts = [...ringsRes.data, ...braceletsRes.data, ...necklacesRes.data];
        ...
        <div className="max-w-7xl mx-auto px-4 py-10">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 mb-8">
                {["ring", "bracelets", "necklace"].map((cat) => {
                    // Find the first product in this category to show as thumbnail
                    ...
                    return (
                        <div
                            ...
                            onClick={() => navigate(`/${cat}`)} // Ensure route matches category name
                        >
                            <img
                ...
                {currentProducts.map((item) => {
                    ...
                    return (
                        <div key={item.id} className="relative border rounded-xl overflow-hidden shadow bg-white hover:shadow-lg transition group">
                            ...
                            <img src={item.image} alt={item.name || item.title} className="w-full h-56 object-cover cursor-pointer" onClick={() => setSelectedProduct(item)} />
